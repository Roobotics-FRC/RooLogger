...
public class RunLogCommand<DrivetrainT extends Subsystem & LoggableDrivetrain> extends Command {
    private DrivetrainT drivetrain;
     ...
     */
    public RunLogCommand(DrivetrainT drivetrain, double duration,
